    ...
    <div className="flex flex-row items-center w-full h-full px-20">
      <div className="flex flex-col flex-1 gap-12">
        <div className="flex flex-col max-w-xl gap-6">
          ...
          <p className="">withdrawing your funds during phase 0 <span className="text-red-500">will reset your points.</span></p>
        ...
        <div className="flex flex-col max-w-md gap-4">
          ...
          <p className="self-start text-sm uppercase cursor-pointer text-brand-300 hover:text-brand-400" onClick={() => setShowModal(true)}>eligible tokens</p>
        </div>
      </div>
                    ...
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="flex flex-col gap-2">
                        <div className="flex flex-row items-center justify-between">
                          <div className="flex items-center gap-2">1. <img src={usdtIcon} width={20} height={20} /><span className="">USDT</span></div>
                          <span>
                            <CiShare1 />
                          </span>
                        </div>
